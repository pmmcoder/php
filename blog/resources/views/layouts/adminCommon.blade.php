...
<head>
    ...
    <!-- Custom CSS -->
    <link href="/css/blog/admin/sb-admin-2.css" rel="stylesheet">
    ...
    <script src="/js/blog/admin/sb-admin-2.js"></script>
</head>
<body>
...
<div id="wrapper">
    ...
    <nav class="navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0">
        <div class="navbar-header">
            ...
            <a class="navbar-brand" href="{{ url('home') }}">Blog Admin v2.0</a>
        </div>
        <!-- /.navbar-header -->
            ...
            <div class="sidebar-nav navbar-collapse">
                <ul class="nav" id="side-menu">
                    ...
                    <li>
                        ...
                        <ul class="nav nav-second-level">
                            <li>
                                <a href="{{ url('panelswells') }}">Panels and Wells</a>
                            </li>
                            <li>
